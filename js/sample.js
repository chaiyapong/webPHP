(function ($, window, document, undefined) {
	var DataTable, page, totalRowOfPage, totalRow, totalPage, startPage, endPage;
	page = 0;
	totalRowOfPage = $("#maxRow").val();
	totalRow = $("#dataTables-example").find('tbody tr').length;
	...
	$("#maxRow").change(function() {
    	...
    	$('#pagination-demo').Pagination({
	        ...
	        onPageClick: function (event, pageSelect) {
	        	...
	        	startPage = (page-1) * totalRowOfPage;
	        	endPage = page * totalRowOfPage;
	       		$("#dataTables-example").find('tbody tr').hide().slice(startPage, endPage).show();
	  		}
    	});
	...
	Pagination.prototype = {
	    ...
	    buildListItems: function (pages) {
	        ...
	        console.log(">>pages.numeric.length");
	        console.log(pages.numeric.length);
