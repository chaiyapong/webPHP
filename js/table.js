...
(/** @lends <global> */function( $ ) {
	...
	{
		console.log(">>step2 add pagin and search");
		var classes = oSettings.oClasses;
		...
		console.log(">oSettings.nHolding");
		console.log(oSettings.nHolding);

		console.log(">oSettings.nTableWrapper");
		console.log(oSettings.nTableWrapper);

		console.log(">oSettings.nTableReinsertBefore");
		console.log(oSettings.nTableReinsertBefore);
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		$(settings.nTable).on( 'search.dt.DT', function ( ev, s ) {
			console.log(">>search.dt.DT for ie9");
			...
			if ( settings === s ) {
				...
				try {
					...
					if ( jqFilter[0] !== document.activeElement ) {
						...
						console.log("jqFilter.val( previousSearch.sSearch )");
						console.log(jqFilter.val( previousSearch.sSearch ));
					}
				}
				catch ( e ) {}
	...
	{
		console.log(">2.1.1 when select change langth");
	...
	{
		console.log(">step 2.1 >_fnFeatureHtmlLength")
		var
		...
		console.log(">settings.aanFeatures.l");
		console.log(settings.aanFeatures.l );
	...
	{
		// console.log(">2.1.1 _fnCallbackFire");
		// console.log(">settings");
		// console.log(settings);
	...
	{
		console.log(">2.1.1 _fnLengthOverflow");
		var
			start = settings._iDisplayStart,
			end = settings.fnDisplayEnd(),
			len = settings._iDisplayLength;
	...
	//return $(this).dataTable({responsive: true}).api();
	//$.fn.DataTable["camelToHungarian"]camelToHungarian
